...
**Related documents:**
- Operator base class: `src/grl/operators/base.py`
- Operator families: `src/grl/operators/{affine,field,kernel}.py`
- Operator generator: `src/grl/policies/generator.py`
